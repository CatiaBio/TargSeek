#!/usr/bin/env python3
"""
Cached gene-taxa coverage check with persistent species-gene dictionary
...
print(f"=== Starting Cached Gene-Taxa Coverage Analysis ===")
...
print(f"\nStarting cached analysis at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
...
print(f"Saving results to: {snakemake.output[0]}")
try:
